    ...
    return (
        ...
        >
            <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="48" height="48" viewBox="0 0 48 48">
                ...
                <path fill="none" stroke={strokeLogo ? "#18193f" : "#f3f4f6"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M40.5,31.5v5	c0,2.209-1.791,4-4,4h-25c-2.209,0-4-1.791-4-4V26"></path>
                <path fill="none" stroke={strokeLogo ? "#18193f" : "#f3f4f6"} strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" d="M7.5,18.064V11.5	c0-2.209,1.791-4,4-4h25c2.209,0,4,1.791,4,4v11.33"></path>
